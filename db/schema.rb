...
ActiveRecord::Schema[7.0].define(version: 2024_10_22_160859) do
  ...
  create_table "loras", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    t.string "name", null: false
  ...
  create_table "showcases", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
